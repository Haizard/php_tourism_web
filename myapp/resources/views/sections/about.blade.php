    ...
    <div class="mx-auto max-w-7xl">
        ...
        <div class="grid gap-6 mt-10 lg:grid-cols-4">
            <div class="rounded-[2rem] border border-slate-200 bg-white/85 p-8 text-center shadow-lg shadow-slate-900/5">
                <div class="mx-auto flex h-16 w-16 items-center justify-center rounded-3xl bg-[var(--color-primary)]/10 text-[var(--color-primary)]">
                    ✓
                </div>
                <h3 class="mt-6 text-xl font-black text-slate-950">Always Available</h3>
                <p class="mt-3 text-sm leading-6 text-slate-600">Four your help</p>
            </div>
            <div class="rounded-[2rem] border border-slate-200 bg-white/85 p-8 text-center shadow-lg shadow-slate-900/5">
                <div class="mx-auto flex h-16 w-16 items-center justify-center rounded-3xl bg-[var(--color-accent)]/10 text-[var(--color-accent)]">
                    ✦
                </div>
            ...
            <div class="rounded-[2rem] border border-slate-200 bg-white/85 p-8 text-center shadow-lg shadow-slate-900/5">
                <div class="mx-auto flex h-16 w-16 items-center justify-center rounded-3xl bg-violet-100 text-[var(--color-primary)]">
                    ✈
                </div>
            ...
            <div class="rounded-[2rem] border border-slate-200 bg-white/85 p-8 text-center shadow-lg shadow-slate-900/5">
                <div class="mx-auto flex h-16 w-16 items-center justify-center rounded-3xl bg-pink-100 text-[var(--color-accent)]">
                    ✧
                </div>
